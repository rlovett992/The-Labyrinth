...
Daedalus can generate and export mazes with a random size based on the selected diffuculty. Also allows the user to pick if the maze is a square or not
